...
(function (global, factory) {
  ...
  function getRatioAndOffset(rotation, circumference, cutout) {
    ...
    if (circumference < TAU) {
      ...
      const calcMax = (angle, a, b) =>
        _angleBetween(angle, startAngle, endAngle) ? 1 : Math.max(a, a * cutout, b, b * cutout);
      const calcMin = (angle, a, b) =>
        _angleBetween(angle, startAngle, endAngle) ? -1 : Math.min(a, a * cutout, b, b * cutout);
  ...
  function _getSegmentMethod(line) {
    ...
    const useFastPath =
      !line._decimated && !line._loop && !opts.tension && !opts.stepped && !borderDash;
